...
const keep = [
  ...
  ...(arena ? ["PAYRUN_ARENA_WALLET", "CDP_API_KEY_ID", "CDP_API_KEY_SECRET", "CDP_WALLET_SECRET", "PAYRUN_SETTLEMENT_SCALE", "ARENA_FEE_USD", "ARENA_DAILY_LIMIT", "ARENA_WALLET_DAILY_LIMIT", "ARENA_BOARD_URL", "UPSTASH_REDIS_REST_URL", "UPSTASH_REDIS_REST_TOKEN", "KV_REST_API_URL", "KV_REST_API_TOKEN"] : []),
